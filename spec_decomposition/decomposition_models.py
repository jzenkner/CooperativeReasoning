...
class DecomposeAttentionTransformerConfig:
  ...
  # The kind of dataset: 'robustfill' or 'deepcoder' or 'lambdabeam'.
...
class DecomposeAttentionTransformer(nn.Module):
  ...
  def setup(self):
    ...
    if self.config.dataset_type in ['robustfill', 'deepcoder', 'lambdabeam']:
  ...
  def encode(self,
    ...
    res = self.encoder(inputs, outputs)
    return res
