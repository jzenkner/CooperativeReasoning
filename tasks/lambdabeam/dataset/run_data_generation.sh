...
lambdabeam_max_int=256
lambdabeam_max_const=5

dataset_name=lambdabeam_data
base_save_dir=./tiips_data/false_positivestrue
...
python -m tasks.lambdabeam.dataset.run_data_generation \
  --seed=${seed} \
  ...
  --max_const=${lambdabeam_max_const} \
